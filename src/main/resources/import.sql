...
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('50000', 'Intel Core I5 6550 Processor', 'IN_STOCK', 3, 1, 6, 5, CURRENT_TIMESTAMP); -- 1
--TopTrade requests a processor from TelnetWork, both managers were selected.
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('40000', 'Intel Core I3 6550 Processor', 'UNDER_SHIPPING', 3, 1, 6, 5, CURRENT_TIMESTAMP); -- 2
--BAV requests a Display from TelnetWork, both managers were selected.
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('25000', 'Dell Display', 'SUCCESSFULLY_COMPLETED', 2, 1, 3, 2, CURRENT_TIMESTAMP); -- 3
--BAV requests carpet from TopTrade, seller manager not set yet.
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('110000', '20 square meter Carpet', 'NEW', 2, 3, 3, NULL, CURRENT_TIMESTAMP); -- 4
--BAV gives an offer for a statue(decoration) for TelnetWork, buyer manager not set yet.
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('110000', 'Statue (Decoration)', 'NEW', 1, 2, NULL, 3, CURRENT_TIMESTAMP); -- 5
--BAV requests a Computer from TelnetWork, seller manager not set yet.
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('110000', 'Office Computer', 'NEW', 2, 1, 3, NULL, CURRENT_TIMESTAMP); -- 6
--ELTE gives an offer for a software development for TelnetWork, buyer manager not set yet.
insert into order_table (price, product_name, status, buyer_id, seller_id, buyer_manager_id, seller_manager_id, created_at) values ('1000000', 'Development of a Warehouse management application', 'NEW', 1, 4, NULL, 1, CURRENT_TIMESTAMP); -- 7
