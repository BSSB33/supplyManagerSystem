        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .content(jsonToString(
                        com.elte.supplymanagersystem.entities.Order.builder()
                                ...
                                .price(3000d)
                                .status(Status.CLOSED)
                                .buyer(Company.builder().id(2L).build())
                                .seller(Company.builder().id(1L).build())
                                .build()
                ))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .content(jsonToString(
                        com.elte.supplymanagersystem.entities.Order.builder()
                                ...
                                .status(Status.CLOSED)
                                .buyer(Company.builder().id(2L).build())
                                .seller(Company.builder().id(3L).build())
                                .build()
                ))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isForbidden());
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .content(jsonToString(
                        com.elte.supplymanagersystem.entities.Order.builder()
                                ...
                                .price(3000d)
                                .status(Status.CLOSED)
                                .buyer(Company.builder().id(1L).build())
                                .seller(Company.builder().id(1L).build())
                                .build()
                ))
                .contentType(MediaType.APPLICATION_JSON))
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .content(jsonToString(
                        com.elte.supplymanagersystem.entities.Order.builder()
                                ...
                                .isArchived(true)
                                .price(2000d)
                                .buyerManager(User.builder().id(2L).build())
                                .sellerManager(User.builder().id(1L).build())
                                .buyer(Company.builder().id(1L).build())
                                .seller(Company.builder().id(4L).build())
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .content(jsonToString(
                        com.elte.supplymanagersystem.entities.Order.builder()
                                ...
                                .buyer(Company.builder().id(2L).build())
                                .seller(Company.builder().id(1L).build())
                                .buyerManager(User.builder().id(3L).build())
                                .build()
                ))
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
